...
from .data.departments import router as departments_data_router
from .data.jobs import router as jobs_data_router
from .data.hired_employees import router as hired_employees_data_router
...
router = APIRouter()
router.include_router(departments_data_router)
router.include_router(jobs_data_router)
router.include_router(hired_employees_data_router)
